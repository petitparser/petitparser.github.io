...
To see PetitParser in action, check out these web-based [examples](https://github.com/petitparser/dart-petitparser/tree/main/petitparser_examples/lib) using [PetitParser for Dart](https://github.com/petitparser/dart-petitparser):
